...
m_dmrNetwork6Enabled(false),
m_dmrNetwork6Name(),
m_dmrNetwork6Id(0U),
m_dmrNetwork6Address(),
m_dmrNetwork6Port(0U),
m_dmrNetwork6Local(0U),
m_dmrNetwork6Password(),
m_dmrNetwork6Options(),
m_dmrNetwork6Location(true),
m_dmrNetwork6Debug(false),
m_dmrNetwork6TGRewrites(),
m_dmrNetwork6PCRewrites(),
m_dmrNetwork6TypeRewrites(),
m_dmrNetwork6SrcRewrites(),
m_dmrNetwork6TGDynRewrites(),
m_dmrNetwork6IdRewrites(),
m_dmrNetwork6PassAllPC(),
m_dmrNetwork6PassAllTG(),
...
bool CConf::read()
{
  ...
  while (::fgets(buffer, BUFFER_SIZE, fp) != NULL) {
	...
	if (section == SECTION_GENERAL) {
			...
			else if (::strcmp(key, "RawNet") == 0)
				m_rawNet = (unsigned short)::atoi(value);
			...
			if (::strcmp(key, "Enabled") == 0)
				...
				m_dmrNetwork6Name = value;
			else if (::strcmp(key, "Id") == 0)
				m_dmrNetwork6Id = (unsigned int)::atoi(value);
			else if (::strcmp(key, "Address") == 0)
				...
				m_dmrNetwork6Options = value;
			else if (::strcmp(key, "Location") == 0)
				m_dmrNetwork6Location = ::atoi(value) == 1;
			else if (::strcmp(key, "Debug") == 0)
				m_dmrNetwork6Debug = ::atoi(value) == 1;
			else if (::strncmp(key, "TGRewrite", 9U) == 0) {
				char* p1 = ::strtok(value, ", ");
				char* p2 = ::strtok(NULL, ", ");
				char* p3 = ::strtok(NULL, ", ");
				...
				if (p1 != NULL && p2 != NULL && p3 != NULL && p4 != NULL && p5 != NULL) {
					...
					rewrite.m_toTG     = ::atoi(p4);
					rewrite.m_range    = ::atoi(p5);
					m_dmrNetwork6TGRewrites.push_back(rewrite);
				}
			} else if (::strncmp(key, "PCRewrite", 9U) == 0) {
				char* p1 = ::strtok(value, ", ");
				char* p2 = ::strtok(NULL, ", ");
				...
				if (p1 != NULL && p2 != NULL && p3 != NULL && p4 != NULL && p5 != NULL) {
					...
					rewrite.m_toId     = ::atoi(p4);
					rewrite.m_range    = ::atoi(p5);
					m_dmrNetwork6PCRewrites.push_back(rewrite);
				}
			} else if (::strncmp(key, "TypeRewrite", 11U) == 0) {
				char* p1 = ::strtok(value, ", ");
				char* p2 = ::strtok(NULL, ", ");
				...
				if (p1 != NULL && p2 != NULL && p3 != NULL && p4 != NULL) {
					...
					char* p5 = ::strtok(NULL, " \r\n");
					rewrite.m_range    = p5 != NULL ? ::atoi(p5) : 1;
					m_dmrNetwork6TypeRewrites.push_back(rewrite);
				}
			} else if (::strncmp(key, "SrcRewrite", 10U) == 0) {
				char* p1 = ::strtok(value, ", ");
				char* p2 = ::strtok(NULL, ", ");
				...
				if (p1 != NULL && p2 != NULL && p3 != NULL && p4 != NULL && p5 != NULL) {
					...
					rewrite.m_toTG     = ::atoi(p4);
					rewrite.m_range    = ::atoi(p5);
					m_dmrNetwork6SrcRewrites.push_back(rewrite);
				}
			} else if (::strncmp(key, "TGDynRewrite", 12U) == 0) {
				std::vector<char*> p7;
				char* p1 = ::strtok(value, ", ");
				...
				if (p1 != NULL && p2 != NULL && p3 != NULL && p4 != NULL && p5 != NULL && p6 != NULL) {
					...
					m_dmrNetwork6TGDynRewrites.push_back(rewrite);
				}
			} else if (::strncmp(key, "IdRewrite", 9U) == 0) {
				char* rfId = ::strtok(value, ", ");
				char* netId = ::strtok(NULL, " \r\n");
				if (rfId != NULL && netId != NULL) {
					...
					rewrite.m_rfId  = ::atoi(rfId);
					rewrite.m_netId = ::atoi(netId);
					m_dmrNetwork6IdRewrites.push_back(rewrite);
				}
			} else if (::strncmp(key, "PassAllPC", 9U) == 0) {
				unsigned int slotNo = (unsigned int)::atoi(value);
				m_dmrNetwork6PassAllPC.push_back(slotNo);
			} else if (::strncmp(key, "PassAllTG", 9U) == 0) {
				unsigned int slotNo = (unsigned int)::atoi(value);
...
unsigned short CConf::getRawNet() const
{
	return m_rawNet;
}
...
unsigned int CConf::getDMRNetwork6Id() const
{
	return m_dmrNetwork6Id;
}

std::string CConf::getDMRNetwork6Address() const
{
...
std::string CConf::getDMRNetwork6Password() const
{
	return m_dmrNetwork6Password;
}

std::string CConf::getDMRNetwork6Options() const
{
	return m_dmrNetwork6Options;
}

bool CConf::getDMRNetwork6Location() const
{
	return m_dmrNetwork6Location;
}

bool CConf::getDMRNetwork6Debug() const
{
	return m_dmrNetwork6Debug;
}

std::vector<CTGRewriteStruct> CConf::getDMRNetwork6TGRewrites() const
{
	return m_dmrNetwork6TGRewrites;
}

std::vector<CPCRewriteStruct> CConf::getDMRNetwork6PCRewrites() const
{
	return m_dmrNetwork6PCRewrites;
}

std::vector<CTypeRewriteStruct> CConf::getDMRNetwork6TypeRewrites() const
{
	return m_dmrNetwork6TypeRewrites;
}

std::vector<CSrcRewriteStruct> CConf::getDMRNetwork6SrcRewrites() const
{
	return m_dmrNetwork6SrcRewrites;
}

std::vector<CTGDynRewriteStruct> CConf::getDMRNetwork6TGDynRewrites() const
{
	return m_dmrNetwork6TGDynRewrites;
}

std::vector<CIdRewriteStruct> CConf::getDMRNetwork6IdRewrites() const
{
	return m_dmrNetwork6IdRewrites;
}

std::vector<unsigned int> CConf::getDMRNetwork6PassAllPC() const
{
	return m_dmrNetwork6PassAllPC;
}

std::vector<unsigned int> CConf::getDMRNetwork6PassAllTG() const
{
